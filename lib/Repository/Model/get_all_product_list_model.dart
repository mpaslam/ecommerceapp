...
//
//     final getAllProductsListModel = getAllProductsListModelFromJson(jsonString);

import 'dart:convert';

GetAllProductsListModel getAllProductsListModelFromJson(String str) => GetAllProductsListModel.fromJson(json.decode(str));

String getAllProductsListModelToJson(GetAllProductsListModel data) => json.encode(data.toJson());
...
class GetAllProductsListModel {
    ...
    factory GetAllProductsListModel.fromJson(Map<String, dynamic> json) => GetAllProductsListModel(
